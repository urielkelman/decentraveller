...
class BlockchainAdapter {
    ...
    async getProposalState(
        ...
        switch (randomValue) {
            case 0:
                return BlockchainProposalStatus.PENDING;
            case 1:
                return BlockchainProposalStatus.ACTIVE;
            case 2:
                return BlockchainProposalStatus.CANCELED;
            case 3:
                return BlockchainProposalStatus.DEFEATED;
            case 4:
                return BlockchainProposalStatus.SUCCEEDED;
            case 5:
                return BlockchainProposalStatus.QUEUED;
            case 6:
                return BlockchainProposalStatus.EXPIRED;
            case 7:
