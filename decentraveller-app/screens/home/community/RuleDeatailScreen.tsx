...
const RuleDetailScreen: React.FC<RuleDetailProps> = ({ route }) => {
    ...
    const renderVoting = () => {
        const subTitle = rule.ruleSubStatus === BlockchainProposalStatus.PENDING ? communityWording.PENDING_VOTATION : communityWording.ACTIVE_VOTATION
        ...
        return (
                ...
                <TouchableOpacity
                    ...
                    disabled={rule.ruleSubStatus === BlockchainProposalStatus.PENDING}
                    style={[ruleDetailStyles.buttonMargin, rule.ruleSubStatus === BlockchainProposalStatus.PENDING && ruleDetailStyles.disabledButton]}
                >
                    <Image
    ...
    return (
        <View style={[ruleDetailStyles.container]}>
            ...
            <Text style={ruleDetailStyles.subtitle}>
                <Text style={ruleDetailStyles.italic}>
                    {subTitleLabel}
                </Text>
            </Text>
            {contentComponent}
