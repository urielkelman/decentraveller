...
const SelectBrokenRuleScreen: React.FC<SelectBrokenRuleScreenProps> = ({ route }) => {
    ...
    return (
        <View style={selectBrokenRuleScreenStyles.container}>
            ...
            <Text style={selectBrokenRuleScreenStyles.subtitleText}> {selectBrokenRuleScreenWordings.SUBTITLE}
            </Text>
            ...
            <View style={selectBrokenRuleScreenStyles.buttonContainer}>
                <DecentravellerButton loading={false} enabled={ruleStatement != ""} text="Censor" onPress={onClickCensor} />
            </View>
        </View>
    );
};
